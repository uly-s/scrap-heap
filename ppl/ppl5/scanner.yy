...
"++"							{ 
										//yylval->build (yytext);
										return yy::simple_parser::make_T_POSTINC(loc); 
                  }

"::"							{ 
										//yylval->build (yytext);
										return yy::simple_parser::make_T_PRED_SEP(loc); 
                  }

"??"							{ 
										//yylval->build (yytext);
										return yy::simple_parser::make_T_PRED_ASSIGN(loc); 
                  }

"?~"							{ 
										//yylval->build (yytext);
										return yy::simple_parser::make_T_PRED_ASSIGN_SC(loc); 
                  }
